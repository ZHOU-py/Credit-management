...
# -*- coding: utf-8 -*-
"""
Created on Wed May  6 23:17:39 2020
...
#        self.gamma = gamma
    ...
    def predict(self, X):
        ...
        self.K.expand(X)
        y_predict = self.b + np.dot(self.K.testMat, self.alpha+self.beta)
    ...
    def predict_prob(self,X):
        y_hat = self.b + np.dot(self.kernelMat, self.alpha+self.beta)
...
#       y_train, y_test = y[train_index], y[test_index]#类别集对应的值
    ...
    clf = LSBFSVM(10,kernel_dict, fuzzyvalue,'origine')
